  ...
  return (
    ...
    {flower._count !== 0  ? (
      <div>
        ...
        <button onclick={handleClick} class="bg-transparent hover:bg-yellow-500 hover:text-white py-2 px-4 border border-yellow-500 hover:border-transparent rounded">🐶画像を変更する</button>
